...
vim.keymap.set('n', '<leader>ff', function() builtin.find_files(defaultopts) end)
...
vim.keymap.set('n', '<leader>fs', function() gs({ search = vim.fn.input('Grep > ') }) end)
vim.keymap.set('n', '<leader>fd', function() fb(bufferdiropts) end)
